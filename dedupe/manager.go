...
func (e *DedupeError) Unwrap() error { return e.Cause }
...
type RedisBackend struct { client *goredis.Client }

func NewRedisBackend(client *goredis.Client) *RedisBackend { return &RedisBackend{client: client} }
...
func NewManager(backend Backend) *Manager { return &Manager{backend: backend} }
